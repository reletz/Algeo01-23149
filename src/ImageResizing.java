...
//     //             // Interpolasi bicubic untuk mendapatkan nilai pixel baru
//     //             int pixelValue = (int) bicubicInterpolationForImage(image, gx, gy);
//     //             int rgb = (pixelValue << 16) | (pixelValue << 8) | pixelValue; // Konversi ke format RGB
//     //             resizedImage.setRGB(x, y, rgb);
//     //         }
...
//             return;
//         }
//         System.out.println("Masukkan width baru: ");
//         int newWidth = scanner.nextInt();
//         scanner.nextLine();
//         System.out.println("Masukkan height baru: ");
//         int newHeight = scanner.nextInt();

//         BufferedImage resizedImage = resizeImageWithScale(image, newWidth, newHeight);
//         try {
//             File outputFile = new File("new_image.jpg");
//             ImageIO.write(resizedImage, "jpg", outputFile);
//             System.out.println("Berhasil menyimpan gambar dengan ukuran yang baru.");
//         } catch (IOException e) {
//             System.out.println("Gagal menyimpan gambar: " + e.getMessage());
//         }
//     }
